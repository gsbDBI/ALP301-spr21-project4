...
get_df_diversity<-function(filename){
  ...
  popularity_ones <- colSums(utility_matrix_old_activity[, index_results_one]>0.3)
  popularity_fives <- colSums(utility_matrix_old_activity[, index_results_five]>0.3)
    
  readers_per_story <- (colSums(utility_matrix_old_activity>0.3)) }
