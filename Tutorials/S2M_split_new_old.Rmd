...
results_df <- tibble(type=types, usage="old", precision.at.5=precision_vector, recall.at.5=recall_vector, rmse=rmse_vector)
...
```{r new users ubcf create recs}

```

```{r new users ubcf all-but-k evaluation}

```

```{r new users ubcf all-but-k fold}

```

```{r new users ubcf diversity}

```

```{r new users ubcf engagement metric}

```

```{r new users ubcf cold start analysis}
