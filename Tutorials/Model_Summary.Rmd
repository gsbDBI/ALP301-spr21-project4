...
```{r load packages and functions, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r utility matrix setup, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r run old, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r new user analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot(data = results_df_new) +
  geom_point(mapping = aes(x = precision.at.5, y = recall.at.5,
                           size=rmse, color=type))
```
```{r plot old vs new user activity, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r diversity, echo=FALSE, message=FALSE, warning=FALSE}
# types <- c("fm", "svd", "cbf", "ubcf", "random", "ibcf")
...
```{r engagement, echo=FALSE, message=FALSE, warning=FALSE}
